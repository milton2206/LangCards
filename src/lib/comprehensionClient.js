...
const DIALOGUES_KEY = "listeningDialogues"; // { "de-ru|mixed|v2": [ {…диалог+вопросы}, … ] }
...
// Ключ набора: пара + источник слов + версия вопросов. Версия в ключе — потому
// что вопросы кэшируются ВМЕСТЕ с диалогом: набор старой версии просто не
// находится, и экран берёт новый диалог с новыми вопросами.
function dialogueKey(pairKey, source = "mixed") {
  return `${pairKey}|${source}|v${QUESTIONS_VERSION}`;
}

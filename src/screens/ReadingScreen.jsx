...
export default function ReadingScreen({
  ...
  takenWords,
  knownWords,
  // Данные уже имеющихся слов пары (перевод, транскрипция, пример): по ним тап
  // по знакомому слову открывает перевод сразу, без запроса к модели.
  wordInfo = null,
  onAddWord,
  onBack,
  ...
  const lookup = useWordLookup({
    ...
    // молча проглотило бы).
    takenWords,
    // Свои карточки: тап по знакомому слову в тексте открывается мгновенно,
    // без похода к модели (см. useWordLookup).
    wordInfo,
  });

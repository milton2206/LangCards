...
- Примеры пиши так, как реально говорят носители ${learn} в повседневной жизни: настоящие бытовые реплики, естественная лексика, живые ситуации по теме. Никаких сухих искусственно-правильных «учебных» конструкций.
...
- Держи уровень (${levelName}): на A1–A2 — просто и коротко, на B1–B2 — разнообразнее и живее, на C1 — идиоматично.
- Перевод на родной язык (${native}) должен звучать так, как носитель ${native} сказал бы это сам: передавай смысл и интонацию, а не переводи слово в слово. Никаких калек и дословщины.
...
- "translation": естественный перевод слова на родной язык пользователя (${native}) — тот вариант, который носитель ${native} действительно использует в этом значении.
- "example": живое предложение на изучаемом языке (${learn}) из реальной повседневной речи, где это слово звучит естественно в контексте темы.
- "exampleTranslation": естественный перевод примера на родной язык (${native}) — так, как это сказали бы на ${native}, а не дословно.

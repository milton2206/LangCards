// ============================================================================
// ПРОВЕРКА УДАРЕНИЯ В ГРЕЧЕСКОЙ ТРАНСКРИПЦИИ — ТОЛЬКО ДЛЯ ЛОГА.
//
...
//
// ЭТО НЕ ОТБРАКОВКА, А СТРОКА В ЛОГ. Замер по бэкапу: на однословных греческих
// карточках проверка дала 57 сопоставимых случаев и НОЛЬ ложных срабатываний,
// но покрывает лишь около 19% греческих карточек — нужны и тонос, и слоговая
// разбивка в транскрипции. Отбраковывать по проверке с таким покрытием значит
// молча резать годные карточки; а вот заметить проблему по логу она позволяет.
//
